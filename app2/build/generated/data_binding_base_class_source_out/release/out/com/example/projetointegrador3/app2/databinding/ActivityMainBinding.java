...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ScrollView rootView, @NonNull Button btnGenerateReport,
      @NonNull Button btnRiskMap, @NonNull MaterialCardView cardReports,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ScrollView) rootView, btnGenerateReport, btnRiskMap,
          cardReports, cardRiskMap, tvTitle);
    }
