...
public class ActivityDashboardBindingImpl extends ActivityDashboardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.totalRiscosText, 1);
        sViewsWithIds.put(R.id.pieChart, 2);
        sViewsWithIds.put(R.id.barChart, 3);
        sViewsWithIds.put(R.id.recentAlertsRecyclerView, 4);
    }
    // views
    @NonNull
    ...
    private ActivityDashboardBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.github.mikephil.charting.charts.PieChart) bindings[2]
